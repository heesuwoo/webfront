...
function addChild(e){
    ...
    // == add.append(document.createTextNode("추가"));
    // == add.append("추가");
...
// 2) 매개변수로 이벤트가 발생한 요소 자체를 전달하는 방법 (this -> 아무변수)
function removeParent(/*el*/ e){
    // console.log(e.target)
    // console.log(el) // 이벤트가 발생한 요소 자체
...
document.getElementById("test2-btn").addEventListener("click", function(){
    ...
    // test2의 첫 번째 자식 요소의 다음 형제 요소가 클릭되었을 때 
